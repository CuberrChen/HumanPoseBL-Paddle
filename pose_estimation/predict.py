...
def main():
    ...
    # linking rule
    points_links = [[0, 1], [0, 2], [1, 3], [2, 4], [0, 5], [0, 6], [6, 8], [8, 10], [5, 7], [7, 9], [5, 11], [6, 12],
                    [11, 13], [13, 15], [12, 14], [14, 16], [12, 11], [6, 5]]
    points_number = 17
    ...
    for i in range(points_number):
        ...
        if prob > threshold:
            ...
            cv2.putText(image, "{}".format(body_parts[i]), (int(x), int(y)), cv2.FONT_HERSHEY_COMPLEX_SMALL, 0.8,
